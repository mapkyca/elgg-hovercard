<?php
/**
 * Elgg user display with Hovercard
 * 
 * TODO: Do this in a much more theme compatible way.
 *
...
$title = "<a data-hovercard=\"".$entity->getUrl()."?view=hovercard\" class=\"hovercard-custom\" href=\"" . $entity->getUrl() . "\" $rel>" . $entity->name . "</a>";
